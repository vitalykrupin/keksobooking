...
(function () {
  ...
  var onMouseMovePin = function (evt) {
  ...
  mapPinMainElement.addEventListener('mousedown', window.page.onActivatePage);
  mapPinMainElement.addEventListener('mousedown', onMouseMovePin);
